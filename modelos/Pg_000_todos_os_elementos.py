...
Fonte: https://www.pysimplegui.org/en/latest/cookbook/#recipe-all-elements-the-everything-bagel-2022-style

Esta janela representa todos os 33 elementos PySimpleGUI em uma única janela. 
Leva cerca de 70 linhas de código para mostrar todos os elementos nesta janela.

O código não é tão prático quanto o que você encontrará nos Programas Demo. 
Esse uso dos elementos é abreviado e não mostra como cada um é usado de maneira típica.
"""
