...
"""
    https://github.com/PySimpleGUI/PySimpleGUI/blob/master/DemoPrograms/Demo_Tabs_Simple.py
    
    Demonstração - Guias Simples

    Como usar o elemento Tab e o elemento TabGroup
